...
::: tip
AIRLAPS supports formalizing the problem one characteristic at a time without the need of being an algorithmic expert nor knowing in advance the best kind of solver for this task (RL, planning, scheduling or any hybrid type).
:::
...
# prints: [<class 'airlaps.hub.solver.lazy_astar.lazy_astar.LazyAstar'>, ...]
