...
<airlaps-signature name= "_get_transition_value" :sig="{'params': [{'name': 'self'}, {'name': 'memory', 'annotation': 'D.T_memory[D.T_state]'}, {'name': 'action', 'annotation': 'D.T_agent[D.T_concurrency[D.T_event]]'}, {'name': 'next_state', 'default': 'None', 'annotation': 'Optional[D.T_state]'}], 'return': 'D.T_agent[TransitionValue[D.T_value]]'}"></airlaps-signature>
...
<airlaps-signature name= "_is_terminal" :sig="{'params': [{'name': 'self'}, {'name': 'state', 'annotation': 'D.T_state'}], 'return': 'bool'}"></airlaps-signature>
...
<airlaps-signature name= "_is_transition_value_dependent_on_next_state" :sig="{'params': [{'name': 'self'}], 'return': 'bool'}"></airlaps-signature>
...
<airlaps-signature name= "_is_transition_value_dependent_on_next_state_" :sig="{'params': [{'name': 'self'}], 'return': 'bool'}"></airlaps-signature>
...
<airlaps-signature name= "GymPlanningDomain" :sig="{'params': [{'name': 'gym_env', 'annotation': 'gym.Env'}, {'name': 'set_state', 'default': 'None', 'annotation': 'Callable[[gym.Env, D.T_memory[D.T_state]], None]'}, {'name': 'get_state', 'default': 'None', 'annotation': 'Callable[[gym.Env], D.T_memory[D.T_state]]'}, {'name': 'termination_is_goal', 'default': 'False', 'annotation': 'bool'}, {'name': 'discretization_factor', 'default': '10', 'annotation': 'int'}, {'name': 'branching_factor', 'default': 'None', 'annotation': 'int'}, {'name': 'max_depth', 'default': '50', 'annotation': 'int'}], 'return': 'None'}"></airlaps-signature>
...
<airlaps-signature name= "_get_goals_" :sig="{'params': [{'name': 'self'}]}"></airlaps-signature>
...
<airlaps-signature name= "_is_positive" :sig="{'params': [{'name': 'self'}, {'name': 'cost', 'annotation': 'D.T_value'}], 'return': 'bool'}"></airlaps-signature>
...
### Constructor <Badge text="GymWidthPlanningDomain" type="tip"/>

<airlaps-signature name= "GymWidthPlanningDomain" :sig="{'params': [{'name': 'gym_env', 'annotation': 'gym.Env'}, {'name': 'set_state', 'default': 'None', 'annotation': 'Callable[[gym.Env, D.T_memory[D.T_state]], None]'}, {'name': 'get_state', 'default': 'None', 'annotation': 'Callable[[gym.Env], D.T_memory[D.T_state]]'}, {'name': 'termination_is_goal', 'default': 'False', 'annotation': 'bool'}, {'name': 'discretization_factor', 'default': '10', 'annotation': 'int'}, {'name': 'branching_factor', 'default': 'None', 'annotation': 'int'}, {'name': 'max_depth', 'default': '50', 'annotation': 'int'}], 'return': 'None'}"></airlaps-signature>
...
### binarize <Badge text="GymWidthPlanningDomain" type="tip"/>
...
### nb\_of\_binary\_features <Badge text="GymWidthPlanningDomain" type="tip"/>
...
### state\_features <Badge text="GymWidthPlanningDomain" type="tip"/>
...
<airlaps-signature name= "AsGymEnv" :sig="{'params': [{'name': 'domain', 'annotation': 'Domain'}, {'name': 'unwrap_spaces', 'default': 'True', 'annotation': 'bool'}], 'return': 'None'}"></airlaps-signature>
...
<airlaps-signature name= "close" :sig="{'params': [{'name': 'self'}]}"></airlaps-signature>
...
<airlaps-signature name= "render" :sig="{'params': [{'name': 'self'}, {'name': 'mode', 'default': 'human'}]}"></airlaps-signature>
...
<airlaps-signature name= "reset" :sig="{'params': [{'name': 'self'}]}"></airlaps-signature>
...
<airlaps-signature name= "seed" :sig="{'params': [{'name': 'self'}, {'name': 'seed', 'default': 'None'}]}"></airlaps-signature>
...
<airlaps-signature name= "step" :sig="{'params': [{'name': 'self'}, {'name': 'action'}]}"></airlaps-signature>
