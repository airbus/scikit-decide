...
<airlaps-signature name= "StableBaseline" :sig="{'params': [{'name': 'algo_class', 'annotation': 'type'}, {'name': 'baselines_policy', 'annotation': 'Any'}, {'name': 'learn_config', 'default': 'None', 'annotation': 'Dict'}, {'name': 'kwargs', 'annotation': 'Any'}], 'return': 'None'}"></airlaps-signature>
