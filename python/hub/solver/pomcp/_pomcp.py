...
from airlaps import Domain, Solver, Memory, DiscreteDistribution
from airlaps.builders.domain import SingleAgent, Sequential, EnumerableTransitions, Actions, Goals, UncertainInitialized
from airlaps.builders.solver import DeterministicPolicies
...
if __name__ == '__main__':
    ...
    MasterMind = hub.load('MasterMind', folder='hub/domain/mastermind')
