...
AsGymEnv = hub.load('AsGymEnv', folder='hub/domain/gym')
...
class StableBaselines(Solver, Policies, Restorable):
    ...
    def __init__(self, algo_class: type, baselines_policy: Any, learn_config: Dict = {}, **kwargs: Any) -> None:
