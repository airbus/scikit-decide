...
from skdecide import Memory, T_observation, T_event, Domain
...
from skdecide.builders.solver import DomainSolver, DeterministicPolicySolver, SolutionSolver, UtilitySolver
