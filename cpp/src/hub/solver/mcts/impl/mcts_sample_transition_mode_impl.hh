...
#define SK_MCTS_SAMPLE_TRANSITION_MODE_TEMPLATE_DECL template <typename Tsolver>

#define SK_MCTS_SAMPLE_TRANSITION_MODE_CLASS SampleTransitionMode<Tsolver>

SK_MCTS_SAMPLE_TRANSITION_MODE_TEMPLATE_DECL
void SK_MCTS_SAMPLE_TRANSITION_MODE_CLASS::init_rollout(
    Tsolver &solver, const std::size_t *thread_id) const {}

SK_MCTS_SAMPLE_TRANSITION_MODE_TEMPLATE_DECL
typename Tsolver::Domain::EnvironmentOutcome
SK_MCTS_SAMPLE_TRANSITION_MODE_CLASS::random_next_outcome(
...
SK_MCTS_SAMPLE_TRANSITION_MODE_CLASS::random_next_node(
    Tsolver &solver, const std::size_t *thread_id,
