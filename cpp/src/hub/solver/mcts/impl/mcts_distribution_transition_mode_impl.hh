 ...
 */
#ifndef SKDECIDE_MCTS_DISTRIBUTION_TRANSITION_MODE_IMPL_HH
#define SKDECIDE_MCTS_DISTRIBUTION_TRANSITION_MODE_IMPL_HH
...
void SK_MCTS_DISTRIBUTION_TRANSITION_MODE_CLASS::init_rollout(
    Tsolver &solver, const std::size_t *thread_id) const {}

SK_MCTS_DISTRIBUTION_TRANSITION_MODE_TEMPLATE_DECL
typename Tsolver::Domain::EnvironmentOutcome
SK_MCTS_DISTRIBUTION_TRANSITION_MODE_CLASS::random_next_outcome(
...
SK_MCTS_DISTRIBUTION_TRANSITION_MODE_CLASS::random_next_node(
    Tsolver &solver, const std::size_t *thread_id,
...
#endif // SKDECIDE_MCTS_DISTRIBUTION_TRANSITION_MODE_IMPL_HH
