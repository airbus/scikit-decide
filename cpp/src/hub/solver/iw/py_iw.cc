...
void init_pyiw(py::module& m) {
    py::class_<skdecide::PyIWSolver> py_iw_solver(m, "_IWSolver_");
        py_iw_solver
            ...
            .def("get_next_action", &skdecide::PyIWSolver::get_next_action, py::arg("state"))
            .def("get_utility", &skdecide::PyIWSolver::get_utility, py::arg("state"))
            .def("get_nb_of_explored_states", &skdecide::PyIWSolver::get_nb_of_explored_states)
            .def("get_nb_of_pruned_states", &skdecide::PyIWSolver::get_nb_of_pruned_states)
            .def("get_intermediate_scores", &skdecide::PyIWSolver::get_intermediate_scores)
        ;
}
