...
SK_BFWS_DOMAIN_STATE_HASH_TEMPLATE_DECL
std::size_t SK_BFWS_DOMAIN_STATE_HASH_CLASS::Hash::operator()(const Key& k) const {
    return typename Tdomain::State::Hash()(k);
}

SK_BFWS_DOMAIN_STATE_HASH_TEMPLATE_DECL
bool SK_BFWS_DOMAIN_STATE_HASH_CLASS::Equal::operator()(const Key& k1, const Key& k2) const {
...
SK_BFWS_STATE_FEATURE_HASH_TEMPLATE_DECL
std::size_t SK_BFWS_STATE_FEATURE_HASH_CLASS::Hash::operator()(const Key& k) const {
    std::size_t seed = 0;
...
SK_BFWS_STATE_FEATURE_HASH_TEMPLATE_DECL
bool SK_BFWS_STATE_FEATURE_HASH_CLASS::Equal::operator()(const Key& k1, const Key& k2) const {
...
: _domain(domain), _state_features(state_features),
  _heuristic(heuristic), _termination_checker(termination_checker),
...
SK_BFWS_SOLVER_TEMPLATE_DECL
SK_BFWS_SOLVER_CLASS::Node::Node(const State& s,
                                 Domain& d,
                                 const std::function<std::unique_ptr<FeatureVector> (Domain& d, const State& s)>& state_features)
: state(s),
