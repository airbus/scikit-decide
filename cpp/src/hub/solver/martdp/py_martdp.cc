...
void init_pymartdp(py::module& m) {
    py::class_<skdecide::PyMARTDPSolver> py_martdp_solver(m, "_MARTDPSolver_");
        py_martdp_solver
            ...
            .def("get_next_action", &skdecide::PyMARTDPSolver::get_next_action, py::arg("state"))
            .def("get_utility", &skdecide::PyMARTDPSolver::get_utility, py::arg("state"))
            .def("get_nb_of_explored_states", &skdecide::PyMARTDPSolver::get_nb_of_explored_states)
