...
public:
  ...
  Requirements &set_probabilistic_effects(bool probabilistic_effects = true);
  bool has_probabilistic_effects() const;

  Requirements &set_rewards(bool rewards = true);
  bool has_rewards() const;

  Requirements &set_mdp();
  bool has_mdp() const;
