...
Type::Type(const std::string &name) : Identifier(name) {}

Type::Type(const Type &other) : Identifier(other), TypeContainer<Type>(other) {}
...
namespace skdecide {
namespace pddl {
std::ostream &operator<<(std::ostream &o, const Type &t) { return t.print(o); }
} // namespace pddl
} // namespace skdecide
