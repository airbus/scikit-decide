...
logging::level Logger::get_level() {
    switch (spdlog::get_level()) {
        ...
        default:
            throw std::runtime_error("Unknown spdlog loggin level " + std::to_string(spdlog::get_level()));
    }
}

bool Logger::check_level(const logging::level& level, const std::string& caller) {
