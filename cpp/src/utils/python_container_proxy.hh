...
public:
  ...
  private:
    ...
    template <typename T> class PrimitiveType : public BaseType {
    public:
...
private:
  ...
  template <typename T> class NumpyImplementation : public BaseImplementation {
  public:
...
inline std::size_t
hash_value(const PythonContainerProxy<SequentialExecution>::value_type &o) {
  return o.hash();
}
inline std::size_t
hash_value(const PythonContainerProxy<ParallelExecution>::value_type &o) {
  return o.hash();
}
