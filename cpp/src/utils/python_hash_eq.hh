...
struct PythonHash {
    inline static py::object _not_implemented_object = py::globals()["__builtins__"]["NotImplemented"];
    inline static std::size_t _python_sys_maxsize = py::module::import("sys").attr("maxsize").template cast<std::size_t>();
    ...
    std::size_t operator()(const py::object& o) const {
        ...
        try {
            std::function<bool (const py::object&, std::size_t&)> compute_hash = [](const py::object& ho, std::size_t& hash_val) {
                ...
                if (!res.is(_not_implemented_object)) {
                    ...
                    hash_val = (res.template cast<long long>()) + _python_sys_maxsize;
                    return true;
                } else {
                    return false;
                }
