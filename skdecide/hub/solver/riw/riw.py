...
try:
    ...
    class RIW(ParallelSolver, Solver, DeterministicPolicies, Utilities, FromAnyState):
        ...
        def __init__(
            ...
            callback: Callable[[Domain, RIW], bool] = None,
        ) -> None:
            """Construct a RIW solver instance
                 ...
                 Args:
                     ...
                     use_simulation_domain (bool, optional): Boolean indicating whether the state
                         transitions should be generated by using the :py:meth`Simulation.sample`
                         method of the domain (True) or the :py:meth`Environment.step` method of
            ...
            debug_logs (bool, optional): Boolean indicating whether debugging messages should be logged (True)
                or not (False). Defaults to False.
            callback (Callable[[Domain, RIW], optional): Function called at the end of each RIW rollout,
            ...
            self._lambdas = [self._state_features, self._callback]
        ...
        def _get_next_action(
            ...
            !!! warning
                ...
                which is why it is advised to call :py:meth:`RIW.is_solution_defined_for` before
        ...
        def _get_utility(self, observation: D.T_agent[D.T_observation]) -> D.T_value:
            ...
            !!! warning
                ...
                it is advised to call :py:meth:`RIW.is_solution_defined_for` before
        ...
        def get_policy(
            ...
            """Get the (partial) solution policy defined for the states for which
                ...
                set in the RIW instance's constructor
        ...
        def get_action_prefix(self) -> List[D.T_agent[D.T_observation]]:
            ...
            state of the environment)
                 ...
                 Returns:
                     ...
                     so far after each call to the :py:meth`RIW.get_best_action` method
            """
