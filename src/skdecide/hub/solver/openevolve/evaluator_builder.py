...
from skdecide.builders.solver import ApplicableActions, Policies
...
class EvolvedPolicies(Policies, ApplicableActions):
    ...
    def _sample_action(
        ...
        if self.using_applicable_actions():
            return self._planner.sample_action(observation, self._applicable_actions)
        else:
